...
void stestBSTInt(uint& testnum, uint& testerr) {
  ...
  try {
    ...
    InsertC(loctestnum, loctesterr, bst, 2);//10
    ...
    Min(loctestnum, loctesterr, bst, true, -1);//20
    ...
    Exists(loctestnum, loctesterr, bst, false, 0);//30
    ...
    Predecessor(loctestnum, loctesterr, bst, true, 5, 4);//40
