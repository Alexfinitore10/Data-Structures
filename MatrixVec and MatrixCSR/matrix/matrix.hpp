...
public:
  ...
  // Copy assignment
  Matrix& operator=(const Matrix&); // Copy assignment of abstract types should not be possible.

  // Move assignment
  Matrix& operator=(Matrix&&)noexcept; // Move assignment of abstract types should not be possible.
