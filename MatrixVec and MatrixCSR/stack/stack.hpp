...
public:
  ...
  // Copy assignment
   Stack& operator=(const Stack&)const = delete; // Copy assignment of abstract types should not be possible.

  // Move assignment
   Stack& operator=(Stack&&)const noexcept = delete; // Move assignment of abstract types should not be possible.
